...
TL1 = TransmissionLine(30, Z3, np.deg2rad(12.01), f0);
TL1.addToSmithChart(theta, cadena);
Z4 = Impedance(Z0, TL1.getImpedance());
TL2 = TransmissionLine(35.4, Z4, np.deg2rad(6.634), f0);
TL2.addToSmithChart(theta, cadena);
Z5 = Impedance(Z0, TL2.getImpedance());
TL3 = TransmissionLine(40, Z5, np.deg2rad(7.391), f0);
...
TL4 = TransmissionLine(40, Z6, np.deg2rad(11.56), f0);
